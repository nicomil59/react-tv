...
const Card = ( {show }) => {
  return (
    <li className='card' style={{marginBottom: "30px", background: "#F7F7F7"}}>
        <img style={{maxWidth: "150px", height: "auto"}} className='card-img' src={show.backdrop_path ? `https://image.tmdb.org/t/p/original${show.backdrop_path}` : './img/poster.jpg'} alt={`affiche de ${show.name}`} />
